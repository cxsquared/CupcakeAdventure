...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/testKitchen.json");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/images/kitchen/kitchen_Background.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/kitchen/kitchen_Cabinet.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/kitchen/kitchen_Fridge.png");
		types.push (lime.Assets.AssetType.IMAGE);
	...
	public static function main () {
		...
		config = {
			...
			build: "83",
			company: "HaxeFlixel",
			file: "CupcakeAdventure",
			fps: 60,
			name: "CupcakeAdventure",
			orientation: "",
